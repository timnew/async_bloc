...
extension FindAncestorExtension on Finder {
  ...
  Finder findAncestorWithText<T extends Widget>(String text,
          {bool skipOffstage = true}) =>
      find.ancestor(
          of: this,
          matching: find.widgetWithText(T, text, skipOffstage: skipOffstage));
  ...
  Finder findAncestorWithIcon<T extends Widget>(IconData icon,
          {bool skipOffstage = true}) =>
      find.ancestor(
          of: this,
          matching: find.widgetWithIcon(T, icon, skipOffstage: skipOffstage));

  Finder findAncestorByElementType<T extends Element>(Type type,
          {bool skipOffstage = true}) =>
      find.ancestor(
          of: this,
          matching: find.byElementType(T, skipOffstage: skipOffstage));
  ...
  Finder findAncestorByPredicate(WidgetPredicate predicate,
          {String? description, bool skipOffstage = true}) =>
      find.ancestor(
        of: this,
        matching: find.byWidgetPredicate(predicate,
  ...
  Finder findAncestorByElementPredicate(ElementPredicate predicate,
          {String? description, bool skipOffstage = true}) =>
      find.ancestor(
        of: this,
        matching: find.byElementPredicate(predicate,
  ...
  Finder findAncestorBySemanticsLabel(Pattern label,
          {bool skipOffstage = true}) =>
      find.ancestor(
          of: this,
          matching: find.bySemanticsLabel(label, skipOffstage: skipOffstage));
